        ...
        <html lang="en">
          ...
          <body>
            <header class="clearfix">
              ...
              <h1>REPORTE VENTAS POR CIUDAD</h1>
            </header>
            <main>
              <table>
                <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="grand total">$140.00</td>
                  </tr>
                </tbody>
              </table>
              </main>
          ...
          <body>
            <header class="clearfix">
              ...
              <div id="project">
                ...
                <div>(02) 2676-263</div>
                <div><a>sillumiquinga@espe.edu.ec</a></div>
              </div>
            </header>
            <main>
              <table>
                <thead>
                  <tr>
                    ...
                    <th>DOLARES VENDIDOS</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td class="service">1</td>
                    <td class="desc">santiago llumiquinga</td>
                    <td class="unit">$140.00</td>
                  </tr>
